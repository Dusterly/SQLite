...
extension Int: Parameter {
	public func statusCode(applyingTo operation: Operation, at index: Int32) -> Int32 {
		return sqlite3_bind_int64(operation.pointer, index, Int64(self))
	}
}

extension Double: Parameter {
	public func statusCode(applyingTo operation: Operation, at index: Int32) -> Int32 {
		return sqlite3_bind_double(operation.pointer, index, self)
	}
}
...
extension Data: Parameter {
	public func statusCode(applyingTo operation: Operation, at index: Int32) -> Int32 {
		return withUnsafeBytes {
			return sqlite3_bind_blob(operation.pointer, index, $0, Int32(count)) { _ in }
		}
	}
}
...
extension String: Parameter {
	public func statusCode(applyingTo operation: Operation, at index: Int32) -> Int32 {
		...
		return sqlite3_bind_text(operation.pointer, index, cstring, Int32(utf8.count)) { _ in }
	}
}
